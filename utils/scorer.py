...
from sklearn.metrics import average_precision_score,average_precision_score,precision_recall_curve,precision_score
...
def link_prediction_logistic(X_train,y_train,X_test,y_test):
    ...
    return metrics.auc(fpr,tpr), average_precision, recall, pr, f1, lg_y_pred_est.tolist()
